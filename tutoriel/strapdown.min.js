...
function addEvent(a,b,c){return a.attachEvent?a.attachEvent("on"+b,c):a.addEventListener(b,c,!1)}function setInnerText(a,b){"undefined"!=typeof a.textContent?a.textContent=b:a.innerText=b}function getScriptBase(a){for(var b="",c=document.getElementsByTagName("script"),d=0;d<c.length;d++)c[d].src.match(a)&&(b=c[d].src);return b.substr(0,b.lastIndexOf("/"))}function upsertTheme(a,b){for(var c=!1,d=document.getElementsByTagName("link"),e=d.length-1;e>=0;e--)if("stylesheet"==d[e].rel&&d[e].href.match(a+"/themes/")){d[e].setAttribute("href",a+"/themes/"+b+".min.css"),c=!0;break}if(console.log(c),!c){var f=document.createElement("link");f.setAttribute("href",a+"/themes/"+b+".min.css"),f.setAttribute("rel","stylesheet"),document.head.appendChild(f)}}function render(a,b,c,d,e){function f(){var a=window.navigator.userAgent,b=a.indexOf("MSIE "),c=a.indexOf("Trident/");if(b>0)return parseInt(a.substring(b+5,a.indexOf(".",b)),10);if(c>0){var d=a.indexOf("rv:");return parseInt(a.substring(d+3,a.indexOf(".",d)),10)}return!1}function g(a,b,c){var d=j.slice(a,b+1).join("").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");for(f()&&(d=d.replace(/(%[^\n]*)\n/g,"$1<br/>\n"));b>a;)j[b]="",b--;j[a]="@@@@"+o.length+"@@@@",c&&(d=c(d)),o.push(d),k=l=m=null}function h(a){k=l=m=null,o=[];var b;/`/.test(a)?(a=a.replace(/~/g,"~T").replace(/(^|[^\\])(`+)([^\n]*?[^`\n])\2(?!`)/gm,function(a){return a.replace(/\$/g,"~D")}),b=function(a){return a.replace(/~([TD])/g,function(a,b){return{T:"~",D:"$"}[b]})}):b=function(a){return a},j=p(a.replace(/\r\n?/g,"\n"),q);for(var c=1,d=j.length;d>c;c+=2){var e=j[c];"@"===e.charAt(0)?(j[c]="@@@@"+o.length+"@@@@",o.push(e)):k?"$"==l&&e.match(/\n/)?(m&&(c=m,g(k,c,b)),k=l=m=null,n=0):e===l?n?m=c:g(k,c,b):e.match(/\n.*\n/)?(m&&(c=m,g(k,c,b)),k=l=m=null,n=0):"{"===e?n++:"}"===e&&n&&n--:"$"===e||"$$"===e?(k=c,l=e,n=0):"begin"===e.substr(1,5)&&(k=c,l="\\end"+e.substr(6),n=0)}return m&&g(k,m,b),b(j.join(""))}function i(a){return a=a.replace(/@@@@(\d+)@@@@/g,function(a,b){return o[b]}),o=null,a}var j,k,l,m,n,o,p,q=/(\$\$?|\\(?:begin|end)\{[a-z]*\*?\}|\\[\\{}$]|[{}]|(?:\n\s*)+|@@@@\d+@@@@)/i;p=3==="aba".split(/(b)/).length?function(a,b){return a.split(b)}:function(a,b){var c,d=[];if(!b.global){c=b.toString();var e="";c=c.replace(/^\/(.*)\/([im]*)$/,function(a,b,c){return e=c,b}),b=RegExp(c,e+"g")}for(var f=b.lastIndex=0;c=b.exec(a);)d.push(a.substring(f,c.index)),d.push.apply(d,c.slice(1)),f=c.index+c[0].length;return d.push(a.substring(f)),d};var r=[],s=[0,0,0,0,0,0],t=["i","i","i","i","i","i"];if(d&&"none"!=d&&"false"!=d)for(var u=d.split("."),v=0;6>v;v++)"a"==u[v]&&(t[v]="a");var w=function(a,b){return"a"==t[b]&&26>=a?String.fromCharCode(96+a):""+a},x=function(a){for(var b=5,c=""+w(a[0],0);b>=0&&!a[b];b--);for(var d=1;b>=d;d++)c+="."+w(a[d],d);return c},r=[],y=new marked.Renderer;y.heading=function(a,b){s[b-1]++;for(var c=b;6>c;c++)s[c]=0;var e,f=x(s),g="h"+f+"_"+a.toLowerCase().replace(/[^-_.\w\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+/g,"-");e=d&&"none"!=d&&"false"!=d?f+" ":"";for(var h=r,c=0;b-1>c;c++)0!=h.length&&Array.isArray(h[h.length-1])||h.push([]),h=h[h.length-1];return h.push({target:"#"+g,title:e+a}),"<h"+b+' style="position:relative;"><a name="'+g+'" class="anchor" href="#'+g+'"><span class="header-link"></span></a>'+e+a+"</h"+b+">"};var z=h(b),A=marked(z,{renderer:y}),B=i(A),C=document.getElementById("content");C.innerHTML=B;for(var D="",E=0;E<C.childNodes.length;E++)if(C.childNodes[E].tagName&&"title"==C.childNodes[E].tagName.toLowerCase()){D=C.childNodes[E].textContent||C.childNodes[E].innerText;break}var F=document.createElement("div");if(F.className="container",D){var G=document.createElement("h1");G.appendChild(document.createTextNode(D)),F.appendChild(G),F.appendChild(document.createElement("hr"))}if("true"==e){var H=document.createElement("ul"),I=function(a,b){for(var c=0;c<a.length;c++){var d;if(Array.isArray(a[c]))d=document.createElement("ul"),I(a[c],d);else{d=document.createElement("li");var e=document.createElement("a");e.setAttribute("href",a[c].target),e.innerHTML=a[c].title,d.appendChild(e)}b.appendChild(d)}};if(I(r,H),!D){var J=document.createElement("h1");J.appendChild(document.createTextNode("Sommaire")),F.appendChild(J),F.appendChild(document.createElement("hr"))}F.appendChild(H),F.appendChild(document.createElement("hr"))}if(C.parentNode.insertBefore(F,C),B!=A)if(window.MathJax)MathJax.Hub.Queue(["Typeset",MathJax.Hub,a]);else{var K=document.createElement("script");K.type="text/javascript",K.src="https://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_SVG";var L=function(){MathJax.Ajax.timeout=6e4,MathJax.Hub.Config({tex2jax:{inlineMath:[["$","$"]],displayMath:[["$$","$$"]],processEscapes:!0,balanceBraces:!0},messageStyle:"none",SVG:{styles:{".MathJax_SVG svg > g, .MathJax_SVG_Display svg > g":{fill:"#4d4d4c",stroke:"#4d4d4c"}},scale:100}}),MathJax.Hub.Queue(["Typeset",MathJax.Hub,a])};K.onload=L,K.onreadystatechange=function(){"complete"==this.readyState&&L()},document.getElementsByTagName("head")[0].appendChild(K)}if("hljs"in window)for(var M=document.getElementsByTagName("code"),v=0,N=M.length;N>v;v++){var O=M[v],P=O.className;"pre"==O.parentNode.nodeName.toLowerCase()&&(O.parentNode.className="code-wrapper "+P,hljs.highlightBlock(O))}else if("prettyPrint"in window){for(var M=document.getElementsByTagName("code"),v=0,N=M.length;N>v;v++){var O=M[v],P=O.className;"pre"==O.parentNode.nodeName.toLowerCase()&&(O.parentNode.className="code-wrapper prettyprint "+P)}prettyPrint()}for(var Q=document.getElementsByTagName("table"),v=0,N=Q.length;N>v;v++){var R=Q[v];R.className="table table-striped table-bordered"}}
!function(a,b){var c=new Persist.Store("strapdown",{swf_path:"/persist.swf"});b.head=b.getElementsByTagName("head")[0],"getElementsByClassName"in b||(b.getElementsByClassName=function(a){function c(a,b){for(var c=[],d=new RegExp("(^| )"+b+"( |$)"),e=a.getElementsByTagName("*"),f=0,g=e.length;g>f;f++)d.test(e[f].className)&&c.push(e[f]);return c}return c(b.body,a)});var d=b.getElementsByTagName("xmp")[0]||b.getElementsByTagName("textarea")[0],e=b.getElementsByTagName("title")[0],f=b.getElementsByClassName("navbar")[0];if(!d)return void console.warn("No embedded Markdown found in this document for Strapdown.js to work on! Visit http://strapdown.ztx.io/ to learn more.");b.body.style.display="none";var g=b.createElement("meta");g.name="viewport",g.content="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0",b.head.firstChild?b.head.insertBefore(g,b.head.firstChild):b.head.appendChild(g);var h=c.get("theme")||d.getAttribute("theme")||"chaitin";h=h.toLowerCase();var i=getScriptBase("strapdown");upsertTheme(i,h);var j=b.createElement("link");j.href=i+"/strapdown.min.css",j.rel="stylesheet",b.head.appendChild(j);var k=function(a,b,c){var d=a.scrollTop,e=b-d,f=0,g=20,h=function(a,b,c,d){return a/=d/2,1>a?c/2*a*a+b:(a--,-c/2*(a*(a-2)-1)+b)},i=function(){f+=g,a.scrollTop=h(f,d,e,c),c>f&&setTimeout(i,g)};i()},l=b.createElement("div");l.className="backtop",l.innerHTML='<i class="backtop-icon"></i>',l.onclick=function(){k(b.body,0,800)},b.body.appendChild(l),b.onscroll=function(){b.body.scrollTop>b.body.offsetHeight/4?l.style.display="inline-block":l.style.display="none"};var m=b.createElement("div");m.className="container",m.id="content",b.body.replaceChild(m,d);var m=b.createElement("div");if(m.className="navbar navbar-default navbar-fixed-top",m.className+=d.getAttribute("edit")?" edit":"",m.className+=d.getAttribute("history")?" history":"",!f&&e){m.innerHTML='<div class="container"><div class="navbar-header"><button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#main-nav" aria-expand="false"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><div class="navbar-brand" id="headline">Tutoriel</div></div><div class="collapse navbar-collapse"></div></div>',b.body.insertBefore(m,b.body.firstChild);var n=e.innerHTML,o=b.getElementById("headline");o&&(o.innerHTML=n);var p=b.getElementById("theme");if(p){var q=["Chaitin","Cerulean","Cosmo","Cyborg","Darkly","Flatly","Journal","Lumen","Paper","Readable","Sandstone","Simplex","Slate","Spacelab","Superhero","United","Yeti"];q.forEach(function(a){if("Reset"==a){var d=b.createElement("li");d.setAttribute("class","divider"),p.appendChild(d)}var e=b.createElement("li"),f=b.createElement("a");setInnerText(f,a),f.setAttribute("href","#"),e.appendChild(f),a.toLowerCase()==h&&(e.className="active"),addEvent(f,"click",function(d){var e=a.toLowerCase();upsertTheme(i,e);var f=b.querySelectorAll("li.active");[].forEach.call(f,function(a){a.className=""}),d.target.parentNode.className="active",c.set("theme",e)}),p.appendChild(e)})}var r=b.getElementsByClassName("dropdown")[0],s=b.getElementsByClassName("navbar-toggle")[0],t=b.getElementsByClassName("navbar-collapse")[0];p&&r&&(addEvent(r,"click",function(){r.className.match(/(?:^|\s)open(?!\S)/)?r.className=r.className.replace(/(?:^|\s)open(?!\S)/g,""):r.className+=" open"}),addEvent(s,"click",function(){var a=t.className.split(" ");a.indexOf("collapse")>-1?a.splice(a.indexOf("collapse"),1):a.push("collapse"),t.className=a.join(" ")}))}var u=d.textContent||d.innerText,v=d.getAttribute("heading_number"),w=d.getAttribute("toc");render(m,u,h,v,w);var x=b.getElementsByTagName("footer")[0];x?x.className.indexOf("footer")<0&&(x.innerHTML+="",x.className="footer container"):(x=b.createElement("footer"),x.innerHTML="",x.className="footer container",b.body.appendChild(x)),b.body.style.display="",b.getElementsByTagName("footer")[0].style.display=""}(window,document);